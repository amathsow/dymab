...
class UAVClusterManager:
    ...
    def _create_clusters_and_sub_maps(self):
        ...
        if positions.size > 0:
            ...
            self.sub_maps = self.resolve_overlaps_by_reducing_bbox(self.sub_maps)
        else:
            print("Insufficient data for clustering.")

    def resolve_overlaps_by_reducing_bbox(self, sub_maps):
        """Resolve overlaps among clusters by reducing bounding boxes."""
