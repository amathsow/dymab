...
do
    ...
    do
        ...
        base_command="./balance -m Linkoping_1000x572.map -a $scenario_file -o test -t 120 --outputPaths=paths.txt --banditAlgo=AlphaUCB --neighborCandidateSizes=5 --seed=0 --alphaUCB=10000 --decayWindow=20 --lambdaDecay=5"
