...
InitLNS::InitLNS(const Instance& instance, vector<Agent>& agents, double time_limit,
         ...
         BasicLNS(instance, time_limit, neighbor_size, screen, bandit_algorithm_name, neighborhoodSizes, alphaUCB, initialEpsilon, lambdaDecay, decayWindow, INIT_COUNT), agents(agents), replan_algo_name(replan_algo_name),
